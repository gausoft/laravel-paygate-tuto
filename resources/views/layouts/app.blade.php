                                        ...
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ $cartItem->name }}</td>
                                                    <td>{{ $cartItem->qty }}</td>
                                                    <td>{{ $cartItem->price }} FCFA</td>
                                                    <td>{{ number_format($cartItem->total, 2) }} FCFA</td>
                                                </tr>
                                                @endforeach
                                                <tr>
                                                    <td></td>
                                                    ...
                                                    <td class="uk-text-bold">Total: {{ number_format(Cart::subtotal(), 2) }} FCFA</td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
